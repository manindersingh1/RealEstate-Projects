        ...
        <div class="module" id="newletter_div">
            ...
            <div class="module-body">
                ...
                <div class="form-horizontal row-fluid">
                    ...
                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">gannjolly@gmail.com | www.homelifemiracle.com</p>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                ...
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        ...
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: http://annageorge.only4agents.com</p>

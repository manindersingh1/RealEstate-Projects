    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li><a href=#>Multiple Condos</a>");
                if (condos_dt.Rows.Count > 0)
                {
                    ...
                    {
                        StrMenu.Append("<li><a href='../DreamHouseDetail.aspx?Id=" + condos_dt.Rows[j]["Id"] + "' title='Home'>" + condos_dt.Rows[j]["Title"] + "</a></li>");
                    }
                    StrMenu.Append("</ul>");
                }
            ...
            dynamicmnus.Text = StrMenu.ToString();
        }

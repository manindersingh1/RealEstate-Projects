...
namespace Property
{
    public partial class Review_home_worth : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string mls = Request.QueryString["address"].ToString();
        ...
        void SearchResidentialPropertiesSearch()
        {
            try
            {
                ...
                cmd.CommandText = "GetResidentialPropertiesTop1";
                cmd.Parameters.AddWithValue("@MLSID_City_PostalCode", mls);

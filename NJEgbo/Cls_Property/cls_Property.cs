    ...
    public class cls_Property
    {
        ...
        public DataTable GetVideoList()
        {
            ...
            try
            {
                ...
                string str = "select Id, Name from tblFiles";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public int InsertPropertyVideo(string Name,string ContentType,byte[] data)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "insert into tblFiles(Name, ContentType,RunFirst) values (@Name, @ContentType,@RunFirst)";
                cmd.Parameters.AddWithValue("@Name", Name);

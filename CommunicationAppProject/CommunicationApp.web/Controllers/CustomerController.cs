                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (CustomerFound == null)
                    {
                        ...
                        if (CustomerUpdate != null)
                        {
                            ...
                            QStr += " ,LastName='" + Customermodel.LastName + "',LastUpdatedOn='" + DateTime.Now + "' ,MiddleName='" + Customermodel.MiddleName + "' ,CityID='" + Convert.ToInt32(Customermodel.CityID) + "' ,StateID='" + Convert.ToInt32(Customermodel.StateID) + "' , ";

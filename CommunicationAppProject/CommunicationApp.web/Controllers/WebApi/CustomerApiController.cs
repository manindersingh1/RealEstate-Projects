...
namespace CommunicationApp.Controllers.WebApi
{
    ...
    public class CustomerApiController : ApiController
    {
        ...
        public CustomerApiController(ITipService TipService, IEventService EventService, IOfficeLocationService OfficeLocationService, ICustomerService CustomerService, IUserService UserService, IUserRoleService UserRoleService, IAdminStaffService AdminStaffService, ISupplierService SupplierService, ISubCategoryService SubCategoryService, ICompanyService CompanyService, IMessageService MessageService, IPdfFormService PdfFormService, IDivisionService DivisionService, IBannerService BannerService, IMessageImageService MessageImageService)
        {
        ...
        public HttpResponseMessage GetEvent(int ParentId)
        {
            try
            {
                ...
                var Events = _EventService.GetEvents().Where(c => Convert.ToDateTime(c.EventDate.ToString("MM/dd/yyyy"), culture) >= TodayDate && c.IsActive == true && c.CustomerId == ParentId).OrderBy(c => c.EventDate).ToList();
        ...
        [HttpGet]
        public HttpResponseMessage UpdateApplicationId([FromUri] int CustomerId, string ApplicationId)
        {
            try
            {

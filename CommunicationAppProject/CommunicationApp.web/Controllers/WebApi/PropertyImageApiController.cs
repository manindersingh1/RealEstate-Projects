...
namespace CommunicationApp.Web.Controllers.WebApi
{
    ...
    public class PropertyImageApiController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> UploadPropertyImages()
        {
            ...
            try
            {
                ...
                Type type = typeof(PropertyModel); // Get type pointer
                ...
                foreach (var key in provider.FormData.AllKeys)
                {
                    if (key == "PropertyId")
                    {
                        ...
                        {
                            PropertyId = Convert.ToInt32(propertyValue);
                            break;
                        }
                    }
                }
                ...
                var PropertyImages = _PropertyImageService.GetPropertyImages().Where(c => c.PropertyId == Convert.ToInt32(PropertyId)).ToList();

                ...
                <div class="module-body" id="newsletter">
                    ...
                    <div style="float: left; width: 99%; background-color: #231f20; border-bottom: 8px solid #eda320; padding: 6px 0;">
                        <div id="userlogo" style="float: left; width: 30%; padding: 6px; text-align: center;">
                            <img id="logoprvw" src="../images/MyLogo.png" alt="" title="" />
                    ...
                    <h2 style="float: left; width: 100%; font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #FFF; margin: 0px;">Kelly Bajwa</h2>
                    ...
                    <p style="float: left; width: 100%; margin: 0">
                        ...
                        <span style="float: left; font-size: 14px; color: #FFF; margin: 0 10px 0 4px;">416-300-5153</span>
                        <span style="float: left; font-size: 15px; color: #c48820; margin: 0 6px 0 1px">Email:</span>
                        <span style="float: left; font-size: 14px; color: #FFF;">kkbajwa24@gmail.com</span>
                    </p>
                    <p style="float: left; width: 100%; margin: 0">
                        <span style="float: left; font-size: 15px; color: #c48820;">Address:</span>
                        <span style="float: left; font-size: 14px; color: #FFF; margin: 0 10px 0 4px;">470 Chrysler Dr # 20,Brampton, ON L6S0C1</span>
                    </p>
                    ...
                    <div style="float: left; width: 100%;">
                        <div style="float: left; width: 30%; padding: 6px; padding: 12px 4px; background: #329495; height: 624px;">
                            <%-- <img style='width: 50%;' src='@Model.AdminPhoto' alt='' title=''>--%>
                            <img src="../Admin/admintemplate/images/kelly_bajwa.jpg" />
                            ...
                            <asp:TextBox MaxLength='900' onkeyDown="checkTextAreaMaxLength(this,event,'900');" ID="SecondContent" Style="float: left; font-family: arial; border: none;overflow-wrap:normal; width: 100%; font-size: 13px; padding: 1px 0 0; background: #329495 none repeat scroll 0 0; font-weight: bold; color: white; white-space: normal; margin-top: 6px; height: 435px;" runat="server" TextMode="MultiLine" PlaceHolder="" class="span8">

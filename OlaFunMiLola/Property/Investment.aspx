<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true"
    CodeBehind="Investment.aspx.cs" Inherits="Property.UpCommingProjects" %>
            ...
            <div class="schedule_appointment_bg">
               <%-- <ul class="dt-sc-tabs-frame">
                ...
                <div style="display: block;" class="schedule_appointment">  
                    <h2>
                        Investment Property Looking for
                    </h2> 
                    <div>
                    ...
                    <div>
                     ...
                     <div>
                        <div class="login_input">
                            <label>
                                Area Looking for</label>
                            <asp:TextBox ID="txtProjectName" runat="server" MaxLength="50" PlaceHolder="Project Name"></asp:TextBox>

<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true"
    CodeBehind="VipAccess.aspx.cs" Inherits="Property.VipAccess" %>
                ...
                <div style="display: block;" class="schedule_appointment">  
                    ...
                    <div>
                        <div class="login_input">
                            <label>
                                Project Name</label>
                            <asp:TextBox ID="ProjectName" runat="server" MaxLength="50" PlaceHolder="Project Name"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"
                                            ControlToValidate="ProjectName" ErrorMessage="Only alphabets are allowed"
                                            ForeColor="Red" ValidationGroup="SaveAppointment" Display="Dynamic" ValidationExpression="^[a-zA-Z ]+$"> </asp:RegularExpressionValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Project Name is Required"
                                ControlToValidate="ProjectName" ForeColor="Red" ValidationGroup="SaveAppointment"
                                Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div>

        ...
        void GetFeaturedProperties()
        {
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (ImageUrl != "images/no-image.gif")
                    {
                        System.Net.HttpWebRequest request = (System.Net.HttpWebRequest)HttpWebRequest.Create(ImageUrl);
                        request.Method = "HEAD";

            ...
            <div class="module">
                ...
                <div class="module-body">
                    <div class="form-horizontal row-fluid">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="basicinput">Choose Project</label>
                            <div class="controls">
                                <asp:DropDownList style="width: 65%;" ID="ddlProject" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                            ...
                            <Columns>
                               <%-- <asp:BoundField DataField="ID" HeaderText="#" SortExpression="ID"></asp:BoundField>--%>
                                <asp:TemplateField HeaderText="Banner" SortExpression="ID">
                                    <ItemTemplate>
                                        <img src='/Multiple_Condos/images/<%#Eval("FileName") %>' alt="" width="100px" height="100px" />
                                    </ItemTemplate>
                                </asp:TemplateField>

    ...
    public partial class Banner : System.Web.UI.Page
    {
        ...
        protected void GrdBlogList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Editrec")
            {
                ...
                imgbanner.ImageUrl = "/Multiple_Condos/images/" + dt.Rows[0]["FileName"].ToString();
                itemOrder.Value = dt.Rows[0]["ItemOrder"].ToString();
                ddlProject.DataValueField = dt.Rows[0]["ProjectId"].ToString();
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            if (updBannerImage.HasFile)
            {
                ...
                //{
                    ...
                    updBannerImage.SaveAs(Server.MapPath("/Multiple_Condos/images") + "\\" + System.IO.Path.GetFileName(updBannerImage.FileName));
                    clsobj.InsertBanners(txtName.Text, fname, Convert.ToInt32(itemOrder.Value),Convert.ToInt32(ddlProject.SelectedValue));
                    FillGridData();
                    txtName.Text = "";
                    itemOrder.Value = "1";
        ...
        public void bindddl()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ddlProject.DataBind();
                //ddlProject.Items.Insert(0, new ListItem("HOMELIFE/MIRACLE REALTY LTD, BROKERAGE", "0"));
            }
        }

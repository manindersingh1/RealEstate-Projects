...
<div class="agent_input">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtPhoneno"
        ValidationGroup="SaveContactInfo" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
...
<div class="agent_input">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"
        ControlToValidate="txtEmail" ValidationGroup="SaveContactInfo" ForeColor="Red"
        Display="Dynamic"></asp:RequiredFieldValidator>
...
<div class="agent_input">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="FreeHome" Display="Dynamic" ControlToValidate="txtMessage" ErrorMessage="EmailID required" SetFocusOnError="true"></asp:RequiredFieldValidator>

    ...
    public partial class HomeMaster : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li><a href='Mortgage_Affordability_Calculator.aspx' title='Mortgage Affordability calculator'>Mortgage Affordability calculator</a> </li>");
        ...
        protected void SiteSetting()
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    lblemailid3.Text = Convert.ToString(dt.Rows[0]["Email3"]);
                    lblemailid2.Text = Convert.ToString(dt.Rows[0]["Email2"]);
                    lblphn2.Text = Convert.ToString(dt.Rows[0]["Mobile2"]);

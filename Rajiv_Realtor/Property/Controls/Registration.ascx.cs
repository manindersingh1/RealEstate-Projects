...
namespace Property.Controls
{
    public partial class Registration : System.Web.UI.UserControl
    {
        ...
        protected void GetDealerInfo()
        {
            try
            {
                ...
                if (eid > 0)
                {
                    ...
                    txtFirstName.Text = Convert.ToString(dt.Rows[0]["Name"]);
        ...
        private void updInfo(int id)
        {
            ...
            cmd.CommandText = "update registration set Name=@Name,Address=@Address,city=@City,State=@State,PhoneNumber=@PhoneNo,UserName=@UserName,Password=@Password where id=@id;";
            cmd.Connection = conn;

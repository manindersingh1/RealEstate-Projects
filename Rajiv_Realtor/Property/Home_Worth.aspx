...
<%--    <link href="css/style.css" rel="stylesheet" />--%>
    ...
    <script type="text/javascript">
        google.maps.event.addDomListener(window, 'load', function () {
           ...
           <%-- var places = new google.maps.places.Autocomplete(document.$('#<%= myTextBox.ClientID %>);--%>
        ...
        <div class="main-container bg clearfix ">
            <div style="padding-top: 76.2px;" class="addre-box-header">
                ...
                <div class="header-addre-form">
                    ...
                    <%--<asp:TextBox CssClass="MainContentSearchBar" ID="search_term" runat="server"></asp:TextBox>--%>

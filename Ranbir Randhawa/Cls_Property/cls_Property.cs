...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public int InsertAdminClient(string Name, string DOB, string Email, string PhoneNo, string Address, string status, string Gender, string Source, string Photopath, string Remarks)
        {
            int result = 0;
            try
            {
        ...
        public int UpdateAdminClient(string Name, string DOB, string Email, string PhoneNo, string Address, string status, string Gender, string Source, string Photopath, string Remarks,string Id)
        {
            int result = 0;
            try
            {
        ...
        public DataTable GetAdminClientbyID(int id)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "select * from AdminClient where id=" + id;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
        ...
        public DataTable GetLeaseProperties()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                string str = "GetLeaseResidentialProperties";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }

            ...
            <div class="module">
                ...
                <div class="module-body">
                    <p>
                        ...
                        <button id="news_letter" style="display: block; float: left; margin-right: 3px;" type="button" class="btn btn-primary" value="Back To Newsletter">Back To OpenHouse</button>
                        ...
                        <button id="just_sold_bck" style="display: none; float: left; margin-right: 3px;" type="button" class="btn btn-primary" value="Back To Newsletter">Back To Just Sold</button>
                ...
                <div class="form-horizontal row-fluid">
                    ...
                    <div class="newsltr_bg" id="frontside_page">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            <div style="float: left; width: 97%; background-image: url(/images/border.png); background-size: cover; background-color: #8a5201;">
                                ...
                                <div id="property_photo_div" data-id="openhouse" style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                                    <img id="property_photo" src="/images/open_house_img.jpg" alt="" title="" style="border-radius: 14px; border: 2px solid white; width: 78%;" />
                                </div>
                            </div>
                            <div style="float: left; width: 100%; background-color: white; border-radius: 12px; margin: 22px 0 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                    ...
                                    <asp:TextBox ID="FirstContent" Style="float: left; margin: 12px 0 0; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; text-align: center; border: none; font-weight: bold;" runat="server" PlaceHolder="Description here..." class="span8">Wednesday, MAY 16 12:30 </asp:TextBox>
                                </div>
                                <div style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                                    <img src="/images/border_line.png" alt="" title="" />
                                </div>
                                <div style="float: left; width: 100%; margin: 6px 0 18px 0; text-align: center;">
                                    ...
                                    <asp:TextBox ID="SecondContent" Style="float: left; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; font-weight: bold; text-align: center; border: none; margin: 12px 0;" runat="server" PlaceHolder="Description here..." class="span8">Wednesday, MAY 16 12:30 </asp:TextBox>
                                </div>
                            </div>
                            <div style="float: left; width: 100%; text-align: center;">
                                <img src="/images/futer_border.png" alt="" title="" style="width: 100%;" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newsltr_bg" id="backside_page" style="display: none">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            <div style="float: left; width: 97%;">
                                <img src="/images/futer_border2.png" alt="" title="" style="width: 100%;" />
                            </div>
                            ...
                            <div style="float: left; width: 97%; background-color: white; border-radius: 12px; padding: 12px; margin: 10px 0;">
                                ...
                                <asp:TextBox ID="ThirdContent" Style="float: left; box-shadow: none; white-space: normal; border: none; height: 233px; width: 100%; color: black; font-size: 15px; text-align: justify; font-family: Arial, Helvetica, sans-serif; line-height: 28px;" runat="server" TextMode="MultiLine" PlaceHolder="" MaxLength="150" class="span8">
                            ...
                            <div style="float: left; width: 100%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    <img src="/images/AjShah.jpg" alt="" title="" style="width: 120px; height: 120px; border-radius: 66px; border: 2px solid white; margin: 3px 0;" />
                                    <h2 style="float: left; margin: 6px 0; text-align: center; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bold;">Ajay Shah</h2>
                                    <p style="float: left; text-align: center; margin: 2px 0; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">P: 416-747-9777</p>
                                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">homekey123@yahoo.ca | www.homelifemiracle.com</p>
                                    ...
                                    <p style="float: left; text-align: center; width: 100%; color: white; margin: 2px 0; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">5010 Steeles Avenue West , Suite 11A , Toronto, Ontario, M9V 5C6</p>
                                </div>
                            </div>
                            <div style="float: left; width: 100%; text-align: center;">
                                <img src="/images/futer_border.png" alt="" title="" style="width: 100%;" />
                    ...
                    <div class="newsltr_bg" id="feature_Front" style="display: none">
                        <div style="float: left; width: 99%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: #005f44; text-align: center;">
                                ...
                                <asp:TextBox ID="First_feature_cntnt" Style="float: left; width: 100%; color: black; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; text-align: center; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                <img src="../images/border_top1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            </div>
                            <div style="position: absolute;">
                                <img src="../images/for_sale_img.png" alt="" title="" style="width: 55%;" />
                            </div>
                            <div id="featured_first_imge" data-id="featured_first" style="float: left; width: 100%;">
                                <img id="featured_first_img" src="../images/featurd_img1.png" alt="" title="" />
                            </div>
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                ...
                                <asp:TextBox ID="Second_feature_cntnt" Style="float: left; text-align: center; width: 100%; color: black; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 20px;" runat="server" PlaceHolder="text here..." class="span8">4+1 Bedrooms, 3 Washrooms </asp:TextBox>
                            </div>
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                <img src="../images/border_futer1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            </div>
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                <div style="float: left; width: 35%;">
                                    <img src="../images/profile_1.png" alt="" title="" style="width: 65%;" />
                                </div>
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Ajay Shah (Broker of Record)</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-747-9777</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: homekey123@yahoo.ca</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.homekey123.com</p>
                                        <div style="float: left; width: 97%; background-color: #101010; padding: 8px; margin: 6px 0;">
                                            <img src="../images/feature_futer_logo.png" alt="" title="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: #005f44;">
                                <div style="float: left; width: 100%; text-align: center; margin-top: 12px;">
                                    <%--<h2 style="float: left; width: 100%; color: white; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">146 Barleyfield Road Brampton</h2>--%>
                                    <asp:TextBox ID="Thirld_feature_cntnt" Style="float: left; text-align: center; width: 100%; color: black; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                    <img src="../images/border_top1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                                </div>
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_second_imge" data-id="featured_second" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_second_img" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_thirld_imge" data-id="featured_thirld" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_thirld_img" src="../images/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_fourth_imge" data-id="featured_fourth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fourth_img" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_fifth_imge" data-id="featured_fifth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fifth_img" src="../images/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                ...
                                <asp:TextBox ID="Fourth_feature_cntnt" Style="float: left; width: 100%; height: 200px; white-space: normal; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 16px; margin: 12px 0 0; color: black; text-align: center; line-height: 26px; text-align: justify;" runat="server" TextMode="MultiLine" PlaceHolder="" MaxLength="150" class="span8">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Ajay Shah(Broker of Record)</h2>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_front" style="display: none;">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: #094fa5; text-align: center; margin-bottom: 6px;">
                                <h2 style="float: left; width: 100%; color: white; font-size: 18px; font-family: 'Times New Roman', Times, serif; font-weight: bold; margin: 8px 0 4px 0; font-style: italic;">Welcome to</h2>
                                <asp:TextBox ID="ftr_2nd_1stcntnt" Style="float: left; background: #094fa5 none repeat scroll 0 0; border: none; width: 100%; color: white; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; text-align: center; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                            </div>
                            <div style="float: left; width: 100%;" id="2nd_ftr_fstimg" data-id="2nd_ftr_fstimg">
                                <img id="ftr_2nd_1stimge" src="../images/featurd_img1.png" alt="" title="" />
                            </div>
                            <div style="float: left; width: 100%;">
                                <div style="float: left; width: 50%;">
                                    <img src="../images/for_sale_img2.png" alt="" title="" style="width: 30%;" />
                                </div>
                                <div style="float: right; width: 50%; margin: 8px 0;">
                                    <asp:TextBox ID="ftr_2nd_2ndcntnt" Style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; text-align: right; font-style: italic; border: none; font-size: 20px; font-weight: bold; color: black;" runat="server" PlaceHolder="text here..." class="span8">4+1 Bedrooms, 3 Washrooms</asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div style="float: left; width: 97%; margin: 12px 0; background-color: #e3e3e3; padding: 6px; border-radius: 8px;">
                                <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                    ...
                                    <asp:TextBox ID="ftr_2nd_3rdcntnt" Style="float: left; white-space: normal; height: 200px; border: none; width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 15px; margin: 12px 0 0; color: #333333; line-height: 26px; text-align: justify;" runat="server" TextMode="MultiLine" PlaceHolder="" MaxLength="150" class="span8">
                                ...
                                <div style="float: left; width: 97%; margin: 8px 0; background-color: #1c1b1d; padding: 6px;">
                                    <div style="float: left; width: 35%;">
                                        <img src="../images/profile_1.png" alt="" title="" style="width: 80%;" />
                                    </div>
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Team Khanlon</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-747-9777</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: homekey123@yahoo.ca</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.homekey123.com</p>
                                            <div style="float: left; width: 97%; background-color: #101010; padding: 8px; margin: 6px 0;">
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 99%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: #094fa5;">
                                <div style="float: left; width: 100%; text-align: center; margin-top: 12px;">
                                    <asp:TextBox ID="ftr_2nd_4thcntnt" Style="float: left; width: 100%; color: white; font-size: 28px; font-weight: bold; background: #094fa5 none repeat scroll 0 0; border: none; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton</asp:TextBox>
                                    <img src="../images/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                                </div>
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_2ndimg" data-id="2nd_ftr_2ndimg">
                                            <img id="ftr_2nd_2ndimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_3rdimg" data-id="2nd_ftr_3rdimg">
                                            <img id="ftr_2nd_3rdimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_4thimg" data-id="2nd_ftr_4thimg">
                                            <img id="ftr_2nd_4thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_5thimg" data-id="2nd_ftr_5thimg">
                                            <img id="ftr_2nd_5thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_6thimg" data-id="2nd_ftr_6thimg">
                                            <img id="ftr_2nd_6thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_7thimg" data-id="2nd_ftr_7thimg">
                                            <img id="ftr_2nd_7thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                        <img src="../images/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Team Khalon</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <%--Just sold postcard functionality--%>
                    <div class="newsltr_bg" id="jst_sold_front" style="display: none">
                        <div style="float: left; width: 98%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 99%; background-color: #bc8b3d; text-align: center; padding: 6px; margin-bottom: 6px;">
                                <img src="../images/jst_sld_img1.png" alt="" title="" style="width: 42%;" />
                            </div>
                            <div  style="float: left; width: 100%;">
                                <img id="jsthold_1stimge" data-id="jsthold_1stimge" src="../images/featurd_img1.png" alt="" title="" />
                            </div>
                            <div style="float: left; width: 100%;">
                                <div style="float: left; width: 50%; margin: 8px 0;">

                                    <asp:TextBox ID="jsthold_1stcntnt" Style="float: left; width: 100%; color: #ce0c07; border: none; font-size: 22px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                </div>
                                <div style="float: left; width: 50%; margin: 8px 0;">
                                    <asp:TextBox ID="jsthold_2ndcntnt" Style="float: left; width: 100%; border: none; color: #222222; font-family: 'Times New Roman', Times, serif; text-align: right; font-style: italic; font-size: 20px; font-weight: bold;" runat="server" PlaceHolder="text here..." class="span8">4+1 Bedrooms, 3 Washrooms </asp:TextBox>
                                </div>
                            </div>
                                ...
                                <div style="float: left; width: 100%;">
                                    ...
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #b80a05; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0; border-bottom: 1px solid;">Team Khalon</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-747-9777</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: homekey123@yahoo.ca</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.homekey123.com</p>
                        ...
                        <div style="float: left; width: 97%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: white; border: 3px solid #161616;">
                                <div style="float: left; width: 100%; text-align: center; margin-top: 12px;">
                                    ...
                                    <img src="../images/recently_sld_img1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                                    <img src="../images/featurd_border_blck.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                                </div>
                                <div style="float: left; width: 100%; margin: 4px 0;">
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <asp:TextBox ID="jsthold_3rdcntnt" Style="float: left; border: none; width: 100%; color: #1e1e1e; text-align: center; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_2ndimge" data-id="jsthold_2ndimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_4thcntnt" Style="float: left; border: none; width: 100%; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            <asp:TextBox ID="jsthold_5thcntnt" Style="float: left; border: none; width: 100%; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; color: #1e1e1e; text-align: center; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_3rdimge" data-id="jsthold_3rdimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_6thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            <asp:TextBox ID="jsthold_7thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #1e1e1e; text-align: center; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_4thimge" data-id="jsthold_4thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_8thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            <asp:TextBox ID="jsthold_9thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #1e1e1e; text-align: center; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_5thimge" data-id="jsthold_5thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_10thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            <asp:TextBox ID="jsthold_11thcntnt" Style="float: left; border: none; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; width: 100%; color: #1e1e1e; text-align: center; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_6thimge" data-id="jsthold_6thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_12thcntnt" Style="float: left; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; border: none; width: 100%; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            <asp:TextBox ID="jsthold_13thcntnt" Style="float: left; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; border: none; width: 100%; color: #1e1e1e; text-align: center; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">146 Barleyfield Road Brampton </asp:TextBox>
                                            <img id="jsthold_7thimge" data-id="jsthold_7thimge" src="../images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                            <asp:TextBox ID="jsthold_14thcntnt" Style="float: left; border: none; width: 100%; background: #bc8b3d none repeat scroll 0 0; box-shadow: none; color: #dc0000; font-size: 18px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;" runat="server" PlaceHolder="text here..." class="span8">Sold more than Asking price $12,6789</asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <%--End Just sold postcard functionality--%>
                    ...
                    <div class="control-group">
                        <div class="">
                            ...
                            <button id="back_side" data-id="openhouse" type="button" class="btn btn-primary" value="Back Side" style="display: block; float: left; padding-top: 3px; margin-right: 7px;">Back Side</button>
                            <button id="front_side" data-id="openhouse" type="button" class="btn btn-primary" value="Front Side" style="display: none; float: left; padding-top: 3px; margin-right: 7px;">Front Side</button>

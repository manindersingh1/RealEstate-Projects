        ...
        <div class="cls_tab_cntent_prprty_dtl">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="property_inner_cntnt">
                    ...
                    <div class="property_price_box">
                        ...
                        <div class="prprty_inner_box_row">
                            <div class="col-md-12 col-sm-12">
                                <div class="property_community_new">
                                    <h3>Price:</h3>
                                    <asp:Label ID="lblPrice" runat="server" Text=""></asp:Label>&nbsp
                        ...
                        <div class="prprty_inner_box_row">
                            <div class="col-md-12 col-sm-12">
                                <div class="property_community_new">
                                    <h3>Address:</h3>
                                    <asp:Label ID="lblAddress" runat="server" Text=""></asp:Label>&nbsp
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:Label ID="lblDescription" runat="server" Text=""></asp:Label>&nbsp
                 </div>
                    </div>
            </div>
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="roco_pro_info">
                    <h2 style="font-size: 19px !important">
                        <asp:Label ID="lblname" runat="server"></asp:Label>Ajay Shah</h2>

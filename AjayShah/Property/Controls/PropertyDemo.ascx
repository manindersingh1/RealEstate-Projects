        ...
        <div class="property_top_inner_bg">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="print_button">
                      <div class="print_clr">
                          <asp:Button ID="btnprint" ValidationGroup="newbutton" runat="server" Text="Print" OnClientClick="PrintDiv()" />
                      <%--  <button id="btnprint" type="button"   onclick="PrintDiv()">Print</button>--%>
                    </div>
                        ...
                        <div class="seaarch_Property_slider_new_demo">
                          ...
                          <div class="print_button_new">
                            <div class="print_clr22">
                                  <asp:Button ID="Button1" ValidationGroup="newbutton" runat="server" Text="Print" OnClientClick="PrintDiv()" />

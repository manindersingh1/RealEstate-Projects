    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>ICC Realtypoint for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                ...
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>ICC Realtypoint<br/>Sales Representative</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>905-461-2424</span><br/>'");

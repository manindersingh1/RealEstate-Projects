                ...
                <div class="property_new_details">
                    ...
                    <div style="margin: 10px 0 0 0">
                      ...
                      <asp:ImageButton ID="ImgAppointment" ImageUrl="~/images/date2.png" CommandName="Appointment"
                                                            ...
                                                            <span><a id="ScheduleAppointment" href="" title="Appointment" runat="server">Appointment</a></span>
                                                            </div>
              ...
              <p> <a target="_blank" href="http://www.edu.gov.on.ca/">School Reports</a> </p>
               ...
               <p><a href="../Calculators.aspx">Calculator</a> </p>
                ...
                <div class="new_detail_bg">
                    <div class="detail_left_section">
                        ...
                        <div id="Commercial" runat="server">
                          ...
                          <div id="Div1" runat="server">
                            <div class="detail_span" runat="server" id="Div2">
                               <img class="image1" src="../images/jasveer_img.png" />
                                     <h5>Jasveer Kahlon</h5>
                                   <span><i class="fa fa-phone"></i> Call:416-893-2061</span>
                            </div>
                    ...
                    <%--<div id="RoomDescription" runat="server" class="detail_left_section">
                        <span><b>Rooms Description</b></span>
                        <br />
                        <div id="Room1" runat="server" visible="false">
                            <div>
                                <span class="detail_left_Des"><b>
                                    <asp:Label ID="lblRooms" runat="server" Text="Room"></asp:Label></b></span>
                                <span class="detail_left_Des"><b>
                                    <asp:Label ID="LblLevels" runat="server" Text="Level"></asp:Label></b></span>
                                <span class="detail_left_Des"><b>
                                    <asp:Label ID="blDims" runat="server" Text="Dimension"></asp:Label></b> </span>
                                <span class="detail_left_Desfeatures"><b>
                                    <asp:Label ID="lblDesc" runat="server" Text="Features"></asp:Label></b> </span>
                            </div>
                            <br />
                            <span class="detail_left_Des">1
                                <asp:Label ID="lblRoom1" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                    <asp:Label ID="lblLevel1" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                        <asp:Label ID="lblRoom1Dim" runat="server" Text=""></asp:Label>
                                    </span><span class="detail_left_Desfeatures">
                                        <asp:Label ID="lblRoom1Desc" runat="server" Text=""></asp:Label>
                                    </span>
                        </div>
                        <div id="Room2" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">2
                                <asp:Label ID="lblRoom2" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                    <asp:Label ID="lblLevel2" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                        <asp:Label ID="lblRoom2Dim" runat="server" Text=""></asp:Label></span>
                            <span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom2Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room3" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">3
                                <asp:Label ID="lblRoom3" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                    <asp:Label ID="lblLevel3" runat="server" Text=""></asp:Label></span> <span class="detail_left_Des">
                                        <asp:Label ID="lblRoom3Dim" runat="server" Text=""></asp:Label></span>
                            <span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom3Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room4" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">4
                                <asp:Label ID="lblRoom4" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel4" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom4Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom4Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room5" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">5
                                <asp:Label ID="lblRoom5" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel5" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom5Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom5Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room6" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">6
                                <asp:Label ID="lblRoom6" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel6" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom6Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom6Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room7" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">7
                                <asp:Label ID="lblRoom7" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel7" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom7Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom7Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room8" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">8
                                <asp:Label ID="lblRoom8" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel8" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom8Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom8Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room9" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">9
                                <asp:Label ID="lblRoom9" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel9" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom9Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom9Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room10" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">10
                                <asp:Label ID="lblRoom10" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel10" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom10Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom10Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                        <div id="Room11" runat="server" visible="false">
                            <br />
                            <span class="detail_left_Des">11
                                <asp:Label ID="lblRoom11" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblLevel11" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Des">
                                <asp:Label ID="lblRoom11Dim" runat="server" Text=""></asp:Label>
                            </span><span class="detail_left_Desfeatures">
                                <asp:Label ID="lblRoom11Desc" runat="server" Text=""></asp:Label>
                            </span>
                        </div>
                    </div>--%>

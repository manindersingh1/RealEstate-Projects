    ...
    public partial class PropertyDemo : System.Web.UI.UserControl
    {
        ...
        void GetPropertyDetails()
        {
            try
            {
                ...
                Session["Address"] = (CheckNullOrEmptyvalue(Convert.ToString(dt.Rows[0]["address"])) + ", " + CheckNullOrEmptyvalue(Convert.ToString(dt.Rows[0]["province"])) + CheckNullOrEmptyvalue(PostalCode));

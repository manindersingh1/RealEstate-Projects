    ...
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        protected void RepeaterPaging_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName.Equals("newpage"))
            {
                ...
                if (Session["SearchType"].ToString() == "Residential" || Session["QueryString"].ToString() == "Residential")
                {
                    SearchResidentialProperties();
                }
                else if (Session["SearchType"].ToString() == "Commercial" || Session["QueryString"].ToString() == "Commercial")
                {
                    SearchCommercialProperties();
                }
                else if (Session["SearchType"].ToString() == "Condo" || Session["QueryString"].ToString() == "Condo")
                {
                    SearchCondoProperties();
                }
                else
        ...
        protected void lnkPrevious_Click(object sender, EventArgs e)
        {
            ...
            if (Session["SearchType"].ToString() == "Residential" || Convert.ToString(Session["QueryString"].ToString()) == "Residential")
            {
                SearchResidentialProperties();
            }
            else if (Session["SearchType"].ToString() == "Commercial" || Convert.ToString(Session["QueryString"].ToString()) == "Commercial")
            {
                SearchCommercialProperties();
            }
            else if (Session["SearchType"].ToString() == "Condo" || Convert.ToString(Session["QueryString"].ToString()) == "Condo")
            {
                SearchCondoProperties();
            }
            else
        ...
        void SearchResidentialProperties()
        {
            try
            {
                var qrystring = Session["QueryString"];
                var srchtype = Convert.ToString(Session["SearchType"]).ToString();
                var municipality = Session["Municipality"];
                ...
                else if ((Convert.ToString(Session["SearchType"]).ToString() == "Residential"))
                {
                    ...
                    {
                        var hometype = Session["HomeType"].ToString();
                        dt = mlsClient.GetResidentialProperties(Session["Municipality"].ToString(), Session["HomeType"].ToString(), Session["MinPrice"].ToString(), Session["MaxPrice"].ToString(), Session["Beds"].ToString(), Session["Baths"].ToString(), Session["SaleLease"].ToString());
                    }
        ...
        void SearchCommercialProperties()
        {
            try
            {
                ...
                if (Convert.ToString(Session["QueryString"]) == "Commercial" && Session["Municipality"] == null)
                {
                    if (keyword != null && keyword != "")
                    {
                        dt = mlsClient.GetAllCommercialProperties("0", keyword.ToString(), "0", "0", "0", "0");
                    }
                    else
                    {
        ...
        void SearchResidentialPropertiesListing()
        {
            ...
            {
                Property1.MLSDataWebServiceSoapClient mlsClient = new Property1.MLSDataWebServiceSoapClient();
                DataTable dt = mlsClient.GetResidentialProperties("0", "0", "0", "0", "0", "0", "0");
                if (dt.Rows.Count > 0)
                {
                    //string str = "select * from [TblLastUpdated]";
                    //SqlDataAdapter adp = new SqlDataAdapter(str, con);

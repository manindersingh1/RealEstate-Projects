<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Property_New.Master" CodeBehind="landing_page_review.aspx.cs" Inherits="Property.landing_page_review" %>
            ...
            geocoder.geocode({ 'address': address }, function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    google.maps.event.addListener(marker1, 'click', function () {
                        infowindow.open(map, marker1); //infowindow add in map

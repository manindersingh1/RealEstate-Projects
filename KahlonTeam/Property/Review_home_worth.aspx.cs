    ...
    public partial class Review_home_worth : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                clsp.Insert_Home_worth(Name.Text, txtlastname.Text, PhoneNumber.Text, Email.Text, ddl.SelectedItem.Text, Request.QueryString["address"].ToString());
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            body = body + "<p>Address : " + Request.QueryString["address"].ToString() + "</p>";
            mail.Body = body;

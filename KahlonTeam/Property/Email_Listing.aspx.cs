...
namespace Property
{
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        {
            this.Page.Title = "kahlonteam Properties:Send Email";
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>kahlonteam Kalra for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>" + ConfigurationManager.AppSettings["PhoneNumber"].ToString() + "</span><br/>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message:</h2>");
                html.AppendLine("<p>Please take a look at Property ID# 101100363 located at " + dt.Rows[0]["Address"].ToString() + "</p>");
                ...
                html.AppendLine("2250 BOVAIRD DRIVE EAST UNIT # 502 BRAMPTON ON L6R 0W3  <br/>Property ID: " + dt.Rows[0]["MLS"].ToString() + "</h2>");
                html.AppendLine("</div>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>kahlonteam.tejassolutions.ca</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>kahlonteam Kalra<br/>Broker of record</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>647-297-0699</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>E-mail:</p><span style='float:left;'>gurdeepkalra@yahoo.com</span><br/>");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>kahlonteam.tejassolutions.ca</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");

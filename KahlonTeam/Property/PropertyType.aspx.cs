...
namespace Property
{
    public partial class PropertyType : System.Web.UI.Page
    {
        ...
        {
            this.Page.Title = "Kahlonteam Properties : Home";
        ...
        void SearchResidentialProperties(string ptype)
        {
            try
            {
                ...
                lblresi.Text = ptype + " Listings";
                    imgresi1.ImageUrl = "images/toronto.png";
                    ...
                    hlresi3.NavigateUrl = "../Search.aspx?Municipality=" + Session["Municipality"].ToString() + " &PropertyType=" + ptype;
                    //string s3 = dt.Rows[3]["RemarksForClients"].ToString();
                     
                    imgresi4.ImageUrl = "images/markham.jpg";
                    hlresi4.NavigateUrl = "../Search.aspx?Municipality=" + Session["Municipality"].ToString() + " &PropertyType=" + ptype;

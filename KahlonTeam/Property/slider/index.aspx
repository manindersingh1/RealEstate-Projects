<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Property.slider.index" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>kahlonteam:: Index</title>
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
                    <asp:Repeater ID="repeater1" runat="server" OnItemDataBound="repeater1_ItemDataBound">
                        <ItemTemplate>
                            <div>
                                <a u="image" href="#">
                                    <asp:Image ID="imgresi" runat="server" ImageUrl='images/img-1.png' />
                                </a>
                                <div u="caption" t="*" class="captionOrange" style="position: absolute; left: 20px; top: 30px; width: 300px; height: 30px;">
                                    <asp:Label ID="lblStyle" runat="server" Text='<%# Eval("TypeOwn1Out")%>'></asp:Label></span></li>
                                </div>
                                <div class="slider_text">
                                    <asp:Label ID="Label1" runat="server" Text='<%# GetAddress(Eval("Address").ToString())%>'></asp:Label><br />
                                    <div class="slider_text1">
                                        <asp:Label ID="Label34" runat="server" Text='<%# GetText(Eval("RemarksForClients").ToString())%>'></asp:Label>
                                    </div>

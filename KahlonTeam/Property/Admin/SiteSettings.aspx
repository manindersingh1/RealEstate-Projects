    ...
    <div class="span9">
        <div class="content">
            <div class="module">
               ...
               <%--    <div class="control-group">
                            <label class="control-label" for="basicinput">Contact Us Image</label>
                            <div class="controls">
                                <asp:FileUpload ID="Updcontact" runat="server" />
                                <asp:Image ID="imgcontact" Width="200px" runat="server" Visible="false" />
                                <asp:Label ID="lblcontact" runat="server"></asp:Label>
                                <asp:ImageButton Style="margin-bottom: 54px;" ImageUrl="../images/negative.png"  OnClick="btncontactusimage_Click" ID="btncontactusimage" Text="Remove" runat="server" />
                            </div>
                        </div>--%>
                         <div class="control-group">
                            <label class="control-label" for="basicinput">Site Brokerage</label>
                            <div class="controls">
                                <asp:DropDownList ID="ddlbrokerage" style="width:67%;" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <%-- <div class="control-group">
                            <label class="control-label" for="basicinput">Virtual Link</label>
                            <div class="controls">
                                <asp:TextBox ID="txtVirtual_link" runat="server" PlaceHolder="Virtual Link..." class="span8"></asp:TextBox>
                            </div>
                        </div>--%>
                        <div class="control-group">
                            <div class="controls">

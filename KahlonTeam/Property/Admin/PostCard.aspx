                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <a id="id" href="AdminClient.aspx?edit=<%#Eval("ID") %>">
                                        <img src="http://teamkahlon.com/images/edit.png" alt="" /></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                ...
                <div class="form-horizontal row-fluid">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            <div style="float: left; width: 97%; background-image: url(/images/border.png); background-size: cover; background-color: #8a5201;">
                                ...
                                <div id="property_photo_div" data-id="openhouse" style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                                    <img id="property_photo" src="http://teamkahlon.com/images/open_house_img.jpg" alt="" title="" style="border-radius: 14px; border: 2px solid white; width: 78%;" />
                                </div>
                            </div>
                            <div style="float: left; width: 100%; background-color: white; border-radius: 12px; margin: 22px 0 12px;">
                                ...
                                <div style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                                    <img src="http://teamkahlon.com/images/border_line.png" alt="" title="" />
                                </div>
                            ...
                            <div style="float: left; width: 100%; text-align: center;">
                                <img src="http://teamkahlon.com/images/futer_border.png" alt="" title="" style="width: 100%;" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newsltr_bg" id="backside_page" style="display: none">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 97%; background-color: white; border-radius: 12px; padding: 12px; margin: 10px 0;">
                                ...
                                <asp:TextBox ID="ThirdContent" MaxLength='1300' onkeyDown="checkTextAreaMaxLength(this,event,'1300');" Style="float: left; box-shadow: none; white-space: normal; border: none; height: 500px; width: 100%; color: black; font-size: 15px; text-align: justify; font-family: Arial, Helvetica, sans-serif; line-height: 28px;" runat="server" TextMode="MultiLine" PlaceHolder="" class="span8">
                            ...
                            <div style="float: left; width: 40%; text-align: center; margin: 8px 0;">
                                <div id="second_imag" style="float: left; width: 100%;">
                                    <img id="secnd_imge" src="/images/open_house_img.jpg" alt="" title="" />

                                </div>
                            </div>
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    <img src="/images/jaz_kahlon.jpg" alt="" title="" style="width: 120px; height: 120px; border-radius: 66px; border: 2px solid white; margin: 3px 0;" />
                                    <h2 style="float: left; margin: 6px 0; text-align: center; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bold;">Team Kahlon</h2>
                                    <p style="float: left; text-align: center; margin: 2px 0; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">P: 416-893-2061</p>
                                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">jasveerkahlon@gmail.com | www.homelifemiracle.com</p>
                    ...
                    <div class="newsltr_bg">
                        <div id="feature_Front" style="float: left; width: 99%; background-color: #FFF; display: none; padding: 12px;">
                            <div style="float: left; width: 100%; background-color: #005f44; text-align: center;">
                                ...
                                <img src="http://teamkahlon.com/images/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            </div>
                            <div style="position: absolute;">
                                <img src="http://teamkahlon.com/images/for_sale_img.png" alt="" title="" style="width: 55%;" />
                            </div>
                            <div id="featured_first_imge" data-id="featured_first" style="float: left; width: 100%;">
                                <img id="featured_first_img" src="http://teamkahlon.com/images/featurd_img1.png" alt="" title="" />
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                <img src="http://teamkahlon.com/images/border_futer1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            </div>
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                <div style="float: left; width: 35%;">
                                    <img src="http://teamkahlon.com/images/jaz_kahlon.jpg" alt="" title="" style="width: 65%;" />
                                </div>
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Team Kahlon (Broker of Record)</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-893-2061</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: jasveerkahlon@gmail.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.teamKahlon.com</p>
                                        <div style="float: left; width: 97%; background-color: #101010; padding: 8px; margin: 6px 0;">
                                            <img src="http://teamkahlon.com/images/feature_futer_logo.png" alt="" title="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_second_imge" data-id="featured_second" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_second_img" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_thirld_imge" data-id="featured_thirld" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_thirld_img" src="http://teamkahlon.com/images/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_fourth_imge" data-id="featured_fourth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fourth_img" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_fifth_imge" data-id="featured_fifth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fifth_img" src="http://teamkahlon.com/images/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_front" style="display: none;">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%;" id="2nd_ftr_fstimg" data-id="2nd_ftr_fstimg">
                                <img id="ftr_2nd_1stimge" src="http://teamkahlon.com/images/featurd_img1.png" alt="" title="" />
                            </div>
                            <div style="float: left; width: 100%;">
                                <div style="float: left; width: 50%;">
                                    <img src="http://teamkahlon.com/images/for_sale_img2.png" alt="" title="" style="width: 30%;" />
                                </div>
                            ...
                            <div style="float: left; width: 97%; margin: 12px 0; background-color: #e3e3e3; padding: 6px; border-radius: 8px;">
                                ...
                                <div style="float: left; width: 97%; margin: 8px 0; background-color: #1c1b1d; padding: 6px;">
                                    <div style="float: left; width: 35%;">
                                        <img src="http://teamkahlon.com/images/jaz_kahlon.jpg" alt="" title="" style="width: 80%;" />
                                    </div>
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Team Kahlon</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-893-2061</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: jasveerkahlon@gmail.com</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.teamKahlon.com</p>
                                            <div style="float: left; width: 97%; background-color: #101010; padding: 8px; margin: 6px 0;">
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_2ndimg" data-id="2nd_ftr_2ndimg">
                                            <img id="ftr_2nd_2ndimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_3rdimg" data-id="2nd_ftr_3rdimg">
                                            <img id="ftr_2nd_3rdimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_4thimg" data-id="2nd_ftr_4thimg">
                                            <img id="ftr_2nd_4thimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_5thimg" data-id="2nd_ftr_5thimg">
                                            <img id="ftr_2nd_5thimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_6thimg" data-id="2nd_ftr_6thimg">
                                            <img id="ftr_2nd_6thimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_7thimg" data-id="2nd_ftr_7thimg">
                                            <img id="ftr_2nd_7thimge" src="http://teamkahlon.com/images/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                        <img src="http://teamkahlon.com/images/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Team Kahlon</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div style="float: left; width: 100%;">
                                    ...
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #b80a05; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0; border-bottom: 1px solid;">Team Kahlon</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-893-2061</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: jasveerkahlon@gmail.com</p>

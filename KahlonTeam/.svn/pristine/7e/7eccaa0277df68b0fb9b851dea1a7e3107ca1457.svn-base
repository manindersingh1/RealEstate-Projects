...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Free-Home">
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="reqfval" runat="server" ValidationGroup="DreamHome"
                Display="Dynamic" ForeColor="Red" ControlToValidate="txtMinimumprice" ErrorMessage="Min price required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ValidationGroup="DreamHome" ForeColor="Red" 
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="DreamHome" ForeColor="Red" 
                runat="server" Display="Dynamic" ControlToValidate="txtMaximumPrice" ErrorMessage="Maximum price required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>

            <asp:CompareValidator ID="CompareValidator2" runat="server" ValidationGroup="DreamHome" ForeColor="Red" 
                ...
                Operator="GreaterThan" ControlToValidate="txtMaximumPrice" ControlToCompare="txtMinimumPrice" ForeColor="Red" ErrorMessage="maximum price should be greater than minimum price " Display="Dynamic"></asp:CompareValidator>
        </div>
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="DreamHome"
                runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtProvince" ErrorMessage="Province required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        </div>
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="DreamHome"
                runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtCity" ErrorMessage="City required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        </div>
        <div class="Infomation">
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="DreamHome"
                runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtAddress" ErrorMessage="Street Address required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        </div>
        <div class="Infomation">
            ...
            <asp:CompareValidator ID="CompareValidator3" runat="server" Operator="DataTypeCheck"
                Type="Integer" ForeColor="Red" ControlToValidate="txtBedroom" ErrorMessage="Value must be number"
        ...
        <div class="Infomation">
            ...
            <asp:CompareValidator ID="CompareValidator4" runat="server" Operator="DataTypeCheck"
                Type="Integer" ForeColor="Red" ControlToValidate="txtBathroom" ErrorMessage="Value must be number"
                ValidationGroup="DreamHome" />
        </div>
        <div class="Infomation">
    ...
    <div class="Free-Home">
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ValidationGroup="DreamHome" ForeColor="Red" 
            ...
            <asp:RegularExpressionValidator ID="regPhone" ValidationGroup="DreamHome" runat="server"
                ControlToValidate="txtPhone" ForeColor="Red" ValidationExpression="^(\(\d{3}\) \d{3}-\d{4}|\d{3}-\d{3}-\d{4}|\d{10})$"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ValidationGroup="DreamHome"
                Display="Dynamic" ForeColor="Red" ControlToValidate="txtEmail" ErrorMessage="EmailID required"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ForeColor="Red" ValidationGroup="DreamHome"
        ...
        <div class="Infomation">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ForeColor="Red" ValidationGroup="DreamHome"

                                    ...
                                    <div class="dt-sc-tabs-container" style="width: 100%;">
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator ID="reqddlName" runat="server" Display="Dynamic" ErrorMessage="Name is Required"
                                                    ControlToValidate="txtName" ValidationGroup="SaveInfo" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                  ControlToValidate="txtName" ErrorMessage="Only alphabets are allowed" Display="Dynamic" ValidationGroup="SaveInfo"
                  ForeColor="Red" ValidationExpression="^[a-zA-Z ]+$"> </asp:RegularExpressionValidator>
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqCompanyName" runat="server" ErrorMessage="Company Name is Required"
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqAddress" runat="server" ErrorMessage="Address is Required"
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqCity" runat="server" ErrorMessage="City is Required"
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqState" runat="server" ErrorMessage="State is Required"
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator ID="reqPhoneNo" runat="server" ValidationGroup="SaveInfo" Display="Dynamic" ControlToValidate="txtPhoneNo" ErrorMessage="Phone no. required" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator ID="reqWebsite" Display="Dynamic" runat="server" ErrorMessage="Website is Required"
                                        ...
                                        <div class="property-type-module medium-module">
                                            <div class="login_input">
                                                ...
                                                <asp:RequiredFieldValidator ID="reqEmailId" Display="Dynamic" runat="server" ErrorMessage="EmailID is Required"
                                                    ControlToValidate="txtWebsite" ValidationGroup="SaveInfo" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="property-type-module medium-module">

<%@ Page Title="" Language="C#" MasterPageFile="~/Property_New.Master" AutoEventWireup="true" CodeBehind="Change_Password.aspx.cs" Inherits="Property.Change_Password" %>
                        ...
                        <div id="divpassword" runat="server" >
                          ...
                          <div class="property-type-module medium-module">
                            ...
                            <div class="login_input">
                                ...
                                <asp:Button ID="btnChange" runat="server" Style="clear: none;" Text="Submit" OnClick="btnChange_Click" />
                            </div>
                            </div>

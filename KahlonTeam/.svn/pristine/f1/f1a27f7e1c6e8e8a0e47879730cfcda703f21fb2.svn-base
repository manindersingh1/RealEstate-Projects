    ...
    public partial class PropertyDetailsControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack == false)
            {
                ...
                Session["MLSID"] = Request.QueryString["MLSID"].ToString();
                ScheduleAppointment.HRef = "../ScheduleAppointment.aspx?MLSID=" + Convert.ToString(Session["MLSID"]) + "&PropertyType=" + Convert.ToString(Session["PropertySearchType"])+"";

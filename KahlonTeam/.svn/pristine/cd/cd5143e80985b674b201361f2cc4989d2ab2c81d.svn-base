...
namespace Property
{
    public partial class Free_home_evaluation : System.Web.UI.Page
    {
        ...
        {
            this.Page.Title = "kahlonteam Properties:Home Evaluation";
            ...
            if (dt.Rows.Count > 0)
            {
                //headingPage.InnerHtml = Convert.ToString(dt.Rows[0]["PageTitle"]);
                //pagecontentdiv.InnerHtml = Convert.ToString(dt.Rows[0]["PageDescription"]);
            }
        }
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mailUser.Body = "Contact Infomation:<br>PhoneNo:" + txtPhone.Text +
                                        "Email:" + txtEmail.Text +
                                      //  + "<br><b>Address</b>" 
                                      //  + txtStreet.Text + "<br><b>City</b>" 
                                      //  + txtCity1.Text + "<br><b>Postal Code</b>" 
                ...
                client.Credentials = new System.Net.NetworkCredential(ConfigurationManager.AppSettings["RegFromMailAddress"].ToString(), ConfigurationManager.AppSettings["FromEmailPassword"].ToString());

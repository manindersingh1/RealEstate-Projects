<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Property_New.Master" CodeBehind="Review_home_worth.aspx.cs" Inherits="Property.Review_home_worth" %>
                ...
                <div class="col-md-9 col-sm-9">
                    <div class="lndng_page_map_1">
                        <div class="landing_page_p">
                            <p>
                                Wow! Great news, Real Estate prices have changed in your neighbourhood. Fill in your details to get instant home evaluation report
                            </p>
                        </div>
                        <div class="home_map">

                    ...
                    <div class="top_section_services">
                        ...
                        <div class="top_sct_img">
                            <a href="../Detail.aspx?PropertyType=Residential">
                                <asp:Image ID="Image3" src="images/img1.png" runat="server" alt="" />
                            </a>
                        </div>
                        <div class="shadow_img">
                            <asp:Image alt="" src="images/shadow_img.png" runat="server" />
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 ">
                    <div class="top_section_services">
                        ...
                        <div class="top_sct_img">
                            <a href="../Detail.aspx?PropertyType=Commercial">
                                <asp:Image ID="Image1" src="images/img2.png" runat="server" alt="" />
                            </a>
                        </div>
                        <div class="shadow_img">
                    ...
                    <div class="top_section_services">
                        ...
                        <div class="top_sct_img">
                            <a href="../Detail.aspx?PropertyType=Condo">
                                <asp:Image ID="Image2" src="images/img3.png" runat="server" alt="" />
                            </a>
                        </div>
                        <div class="shadow_img">
                            <asp:Image src="images/shadow_img.png" alt="" runat="server" />
                    ...
                    <div class="top_section_services">
                        ...
                        <div class="top_sct_img">
                            <a href="../Featured_Properties.aspx">
                                <asp:Image ID="Image4" src="images/featured-property.png" runat="server" alt="" />
                            </a>
                        </div>
                        <div class="shadow_img">
                            <asp:Image src="images/shadow_img.png" alt="" runat="server" />
